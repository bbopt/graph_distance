        ...
        for j in range(nb_rand_trials):
            ...
            while len(draw) != 0:
                ...
                if model == "IDW":
                    ...
                    IDW_naive_bb = variant4_bb_wrapper(X_train_naive_partial, y_train_naive_partial,
                    ...
                    IDW_graph_bb = variant4_bb_wrapper(X_train_graph_partial, y_train_graph_partial,
                    ...
                    IDW_hybrid_bb_test = variant4_bb_wrapper(X_train_hybrid_partial, y_train_hybrid_partial,
