...
from utils.distances import graph_structured_distance, general_distance, hybrid_distance_variant4
...
def variant4_bb_wrapper(X_train, y_train, X_valid, y_valid, nb_max_var, nb_var_sub, approach, model):
    ...
    if approach == "graph":
        ...
        if model == "IDW":
            def IDW_hybrid_variant4_bb(w11, w12, w13, w14, w15, w16, w17,
                                       w21, w22, w23, w24, w25, w26, w27, w28):
                # "ASGD" : (l, u1, u2, lr, a1, a2, a3), parameters are weight w11, w12, w13, w14, w15, w16, w17
                distance_ASGD = hybrid_distance_variant4([w11, w12, w13, w14, w15, w16, w17], "ASGD", p=2)
                ...
                # "ADAM" : (l, u1, u2, u3, lr, b1, b2, b3), parameters are weight w21, w22, w23, w24, w25, w26, w27, w28
                distance_ADAM = hybrid_distance_variant4([w21, w22, w23, w24, w25, w26, w27, w28], "ADAM", p=2)
            ...
            def KNN_hybrid_variant4_bb(w11, w12, w13, w14, w15, w16, w17,
                                       w21, w22, w23, w24, w25, w26, w27, w28, K1, K2):
                ...
                # "ADAM" : (l, u1, u2, u3, lr, b1, b2, b3, K), parameters are weight w21, w22, w23, w24, w25, w26, w27, w28, K2
                distance_ADAM = hybrid_distance_variant4([w21, w22, w23, w24, w25, w26, w27, w28], "ADAM", p=2)
