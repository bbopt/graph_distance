...
def variant2_bb_wrapper(X_train, y_train, X_valid, y_valid, nb_max_var, nb_var_sub, approach, model):
    ...
    if approach == "graph":
        ...
        if model == "IDW":
            ...
            def IDW_graph_variant2_bb(theta_u2, theta_u3, w1, w2, w3, w4, w5, w6, w7, w8):
        ...
        if model == "IDW":
            ...
            def IDW_naive_variant2_bb(w11, w12, w13, w14, w15,
        ...
        if model == "IDW":
            def IDW_hybrid_variant2_bb(w1, w2, w3, w4, w5, w6, w7, w8):
