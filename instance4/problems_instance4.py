...
def instance4_bb_wrapper(X_train, y_train, X_valid, y_valid, nb_max_var, nb_var_sub, approach, model):

    if approach == "graph":

        if model == "IDW":
            def IDW_graph_instance4_bb(theta_u2, theta_u3, theta_hp11, theta_hp12, theta_hp13, theta_hp21, theta_hp22, theta_hp23,
                                       cat_o,
            ...
            return IDW_graph_instance4_bb

        elif model == "KNN":

            def KNN_graph_instance4_bb(theta_u2, theta_u3, theta_hp11, theta_hp12, theta_hp13, theta_hp21, theta_hp22, theta_hp23,
                                       cat_o,
                                       w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12,
                                       K):
                # Variable type [o=-1, l=-1, u1=-1, u2=theta, u3=theta, lr=-1,
            ...
            return KNN_graph_instance4_bb

    elif approach == "naive":

        if model == "IDW":
            def IDW_naive_instance4_bb(w11, w12, w13, w14, w15,
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return IDW_naive_instance4_bb

        elif model == "KNN":
            def KNN_naive_instance4_bb(w11, w12, w13, w14, w15,
                                       w21, w22, w23, w24, w25, w26,
                                       w31, w32, w33, w34, w35,
                                       w41, w42, w43, w44, w45, w46,
                                       w51, w52, w53, w54, w55, w56, w57,
