...
from utils.distances import graph_structured_distance, general_distance, hybrid_distance_variant3


def variant3_bb_wrapper(X_train, y_train, X_valid, y_valid, nb_max_var, nb_var_sub, approach, model):

    if approach == "graph":

        if model == "IDW":
            def IDW_graph_variant3_bb(theta_u2, theta_hp11, theta_hp12, theta_hp13, theta_hp21, theta_hp22, theta_hp23,
                                         cat_o,
                ...
                thetas = [-1, -1, -1, 10**theta_u2, -1,
                          10**theta_hp11, 10**theta_hp12, 10**theta_hp13,
                          10**theta_hp21, 10**theta_hp22, 10**theta_hp23]
            ...
            return IDW_graph_variant3_bb

        elif model == "KNN":
            def KNN_graph_variant3_bb(theta_u2, theta_hp11, theta_hp12, theta_hp13, theta_hp21, theta_hp22, theta_hp23,
                                         cat_o,
                                         w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11,
                                         K):
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return KNN_graph_variant3_bb

    elif approach == "naive":

        if model == "IDW":
            def IDW_naive_variant3_bb(w11, w12, w13, w14, w15,
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return IDW_naive_variant3_bb

        elif model == "KNN":

            def KNN_naive_variant3_bb(w11, w12, w13, w14, w15,
                                         w21, w22, w23, w24, w25, w26,
                                         w31, w32, w33, w34, w35,
                                         w41, w42, w43, w44, w45, w46,
                                         K1, K2, K3, K4):
            ...
            return KNN_naive_variant3_bb

    elif approach == "hybrid":

        if model == "IDW":
            def IDW_hybrid_variant3_bb(w11, w12, w13, w14, w15, w16, w17,
                                       w21, w22, w23, w24, w25, w26, w27):
                # "ASGD" : (l, u1, u2, lr, a1, a2, a3), parameters are weight w11, w12, w13, w14, w15, w16, w17
                distance_ASGD = hybrid_distance_variant3([w11, w12, w13, w14, w15, w16, w17], p=2)
                ...
                # "ADAM" : (l, u1, u2, lr, b1, b2, b3), parameters are weight w21, w22, w23, w24, w25, w26, w27
                distance_ADAM = hybrid_distance_variant3([w21, w22, w23, w24, w25, w26, w27], p=2)
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return IDW_hybrid_variant3_bb

        elif model == "KNN":
            def KNN_hybrid_variant3_bb(w11, w12, w13, w14, w15, w16, w17,
                                       w21, w22, w23, w24, w25, w26, w27, K1, K2):
                # "ASGD" : (l, u1, u2, lr, a1, a2, a3, K), parameters are weight w11, w12, w13, w14, w15, w16, w17, K1
                distance_ASGD = hybrid_distance_variant3([w11, w12, w13, w14, w15, w16, w17], p=2)
                model_KNN_ASGD = KNN(X_train["ASGD"], y_train["ASGD"], distance_ASGD, K1)
                RMSE_ASGD = model_KNN_ASGD.RMSE(X_valid["ASGD"], y_valid["ASGD"])
                nb_pts_ASGD = X_valid["ASGD"].shape[0]

                # "ADAM" : (l, u1, u2, lr, b1, b2, b3, K), parameters are weight w21, w22, w23, w24, w25, w26, w27, K2
                distance_ADAM = hybrid_distance_variant3([w21, w22, w23, w24, w25, w26, w27], p=2)
