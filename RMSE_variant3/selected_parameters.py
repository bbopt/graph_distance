...
from utils.draw import draw_subpbs_candidates_variant3
...
if __name__ == '__main__':
    ...
    nb_pts_train = 2*(nb_test_pts[0]+nb_valid_pts[0] + nb_test_pts[1]+nb_valid_pts[1]) - 4
    ...
    if load_RMSE_dataset:
        ...
        for j in range(nb_rand_trials):
            ...
            while len(draw) != 0:
                ...
                idx_train_partial_hybrid_ADAM = idx_train_subs_partial["ADAM", 1] + idx_train_subs_partial["ADAM", 2]
                ...
                if model == "IDW":
                    ...
                    IDW_naive_bb = variant3_bb_wrapper(X_train_naive_partial, y_train_naive_partial,
                    ...
                    IDW_graph_bb = variant3_bb_wrapper(X_train_graph_partial, y_train_graph_partial,
                    ...
                    IDW_hybrid_bb_test = variant3_bb_wrapper(X_train_hybrid_partial, y_train_hybrid_partial,
                                                             X_test_hybrid, y_test_hybrid, nb_max_var, nb_var_sub, "hybrid", "IDW")
                ...
                draw = draw_subpbs_candidates_variant3(idx_train_subs["ASGD", 1], idx_train_subs["ASGD", 2],
