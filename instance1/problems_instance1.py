...
def instance1_bb_wrapper(X_train, y_train, X_valid, y_valid, nb_max_var, nb_var_sub, approach, model):

    if approach == "graph":

        if model == "IDW":

            def IDW_graph_instance1_bb(theta_u2, theta_u3, w1, w2, w3, w4, w5):
            ...
            return IDW_graph_instance1_bb

        elif model == "KNN":

            def KNN_graph_instance1_bb(theta_u2, theta_u3, w1, w2, w3, w4, w5, K):
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return KNN_graph_instance1_bb

    elif approach == "naive":

        if model == "IDW":

            def IDW_naive_instance1_bb(w11, w12, w21, w22, w23, w31, w32, w33, w34):
            ...
            # Return a parametrized (w.r.t partial dataset) blackbox
            return IDW_naive_instance1_bb

        elif model == "KNN":

            def KNN_naive_instance1_bb(w11, w12, w21, w22, w23, w31, w32, w33, w34, K1, K2, K3):
